""" Модуль сущностей Вконтакте, отвечающий за:
    ...
    Дополнительно модуль имеет отдельный класс "VKGeoData" для сбора информации о любых топонимах из базы данных ВК
    для её последующей записи в собственную БД программы."""
